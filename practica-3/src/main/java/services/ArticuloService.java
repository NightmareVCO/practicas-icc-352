...
//    articulos.get(0).setComentarios(comentarios);
  ...
  public List<Articulo> findAll(){return this.dbFindAll();}
  public Articulo create(Articulo articulo){return this.dbCreate(articulo);}
  public Articulo modify(Articulo articulo){return this.dbModify(articulo);}
  public boolean delete(String articuloId){return this.dbRemove(articuloId);}
}
}
